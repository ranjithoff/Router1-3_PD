...
if {$CTS_NDR_RULE_NAME != ""} {
	...
	create_routing_rule $CTS_NDR_RULE_NAME \
		...
		-spacings { M2 0.16 M3 0.45 M4 0.45 M5 1.1 M6 1.5 } \
		-spacing_length_thresholds {M2 3.0 M3 3.0 M4 4.0 M5 4.0 M6 4.5} \
		-taper_distance 0.4 \
...
if {$CTS_LEAF_NDR_RULE_NAME != ""} {
	...
	create_routing_rule $CTS_LEAF_NDR_RULE_NAME \
		-default_reference_rule \
		-spacings { M2 0.16 M3 0.45 M4 0.45 M5 1.1 M6 1.25 }
